...
public class PrincipalDatas {
	...
	public static void main(String args[]) {
		...
		System.out.println("Diferen�a apenas Anos:\t\t" + periodo.getYears());
	    System.out.println("Diferen�a apenas Meses:\t\t" + periodo.getMonths());
	    System.out.println("Diferen�a apenas Dias:\t\t" + periodo.getDays());
	    System.out.println();

	    System.out.println("Diferen�a Total em dias:\t" + ChronoUnit.DAYS.between(fixa, data));
	    System.out.println("Diferen�a Total em meses:\t" + ChronoUnit.MONTHS.between(fixa, data));
	    System.out.println("Diferen�a Total em anos:\t" + ChronoUnit.YEARS.between(fixa, data));
		System.out.println();
